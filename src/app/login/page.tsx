...
export default function LoginPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    setLoading(true);
    try {
      // 1) Call your login API (sets HttpOnly cookie on success)
      ...
      // 2) Option A: we already returned user in the login response
      //    If your /api/auth/login returns { user: { role } }, we can use it directly:
  ...
  return (
    // Full-page split: image (left) + form (right)
